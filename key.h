...
const uint16_t usb_dongle_revoke_list[] = {0, 2, 13, 32, 34, 176, 241};
static uint8_t usb_dongle_key[20];
static uint8_t usb_dongle_master_key[20] = {0x46, 0xDC, 0xEA, 0xD3, 0x17, 0xFE, 0x45, 0xD8, 0x09, 0x23, 0xEB, 0x97, 0xE4, 0x95, 0x64, 0x10, 0xD4, 0xCD, 0xB2, 0xC2};

static uint8_t dongle_id[2];

static uint8_t jig_challenge[64];
